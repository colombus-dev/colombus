...
export default function GraphContainer({
	...
	return (
		<div {...props} className={props.className}>
			...
			{!isLoading && (
				<>
					<ProfileExplorerGraphSettingsBar className="absolute top-4 right-12 w-72 h-[calc(100%-2rem)] bg-white/95 backdrop-blur-sm border border-slate-200/80 rounded-[20px] p-5 shadow-[0_10px_30px_rgba(15,23,42,0.06)] z-10" />
					<GraphControls
